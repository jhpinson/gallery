...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Album.album_count'
        db.add_column('medias_album', 'album_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Album.image_count'
        db.add_column('medias_album', 'image_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Album.video_count'
        db.add_column('medias_album', 'video_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Album.album_count'
        db.delete_column('medias_album', 'album_count')

        # Deleting field 'Album.image_count'
        db.delete_column('medias_album', 'image_count')

        # Deleting field 'Album.video_count'
        db.delete_column('medias_album', 'video_count')
