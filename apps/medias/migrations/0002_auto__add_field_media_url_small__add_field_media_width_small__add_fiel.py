...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.url_small'
        db.add_column('medias_media', 'url_small',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True),
                      keep_default=False)

        # Adding field 'Media.width_small'
        db.add_column('medias_media', 'width_small',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Media.height_small'
        db.add_column('medias_media', 'height_small',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Media.url_medium'
        db.add_column('medias_media', 'url_medium',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True),
                      keep_default=False)

        # Adding field 'Media.width_medium'
        db.add_column('medias_media', 'width_medium',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Media.height_medium'
        db.add_column('medias_media', 'height_medium',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Media.url_large'
        db.add_column('medias_media', 'url_large',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True),
                      keep_default=False)

        # Adding field 'Media.width_large'
        db.add_column('medias_media', 'width_large',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Media.height_large'
        db.add_column('medias_media', 'height_large',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Media.url_small'
        db.delete_column('medias_media', 'url_small')

        # Deleting field 'Media.width_small'
        db.delete_column('medias_media', 'width_small')

        # Deleting field 'Media.height_small'
        db.delete_column('medias_media', 'height_small')

        # Deleting field 'Media.url_medium'
        db.delete_column('medias_media', 'url_medium')

        # Deleting field 'Media.width_medium'
        db.delete_column('medias_media', 'width_medium')

        # Deleting field 'Media.height_medium'
        db.delete_column('medias_media', 'height_medium')

        # Deleting field 'Media.url_large'
        db.delete_column('medias_media', 'url_large')

        # Deleting field 'Media.width_large'
        db.delete_column('medias_media', 'width_large')

        # Deleting field 'Media.height_large'
        db.delete_column('medias_media', 'height_large')
