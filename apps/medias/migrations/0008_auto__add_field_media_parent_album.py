...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.parent_album'
        db.add_column('medias_media', 'parent_album',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='medias', null=True, to=orm['medias.Album']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Media.parent_album'
        db.delete_column('medias_media', 'parent_album_id')
