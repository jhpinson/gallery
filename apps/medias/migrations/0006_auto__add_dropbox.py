...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('medias_dropbox', (
            ('album_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['medias.Album'], unique=True, primary_key=True)),
            ('delta', self.gf('django.db.models.fields.CharField')(max_length=256, null=True)),
        ))
        db.send_create_signal('medias', ['DropBox'])


    def backwards(self, orm):
        # Deleting model 'DropBox'
        db.delete_table('medias_dropbox')
    ...
    models = {
        ...
        'medias.dropbox': {
            ...
            'delta': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True'})
        },
        'medias.image': {
