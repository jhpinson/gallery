...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoVersion.size'
        db.add_column('medias_videoversion', 'size',
                      self.gf('django.db.models.fields.CharField')(default=1280, max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoVersion.size'
        db.delete_column('medias_videoversion', 'size')
