...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Media.album'
        db.alter_column('medias_media', 'album_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['medias.Album']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Media.album'
        db.alter_column('medias_media', 'album_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['medias.Media']))
    ...
    models = {
        ...
        'medias.media': {
            'Meta': {'ordering': "['-is_an_album', 'date']", 'unique_together': "(('hash', 'album'),)", 'object_name': 'Media'},
            'album': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'medias'", 'null': 'True', 'to': "orm['medias.Album']"}),
