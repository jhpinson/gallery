...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoVersion.status'
        db.add_column('medias_videoversion', 'status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


        # Changing field 'VideoVersion.type'
        db.alter_column('medias_videoversion', 'type', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):
        # Deleting field 'VideoVersion.status'
        db.delete_column('medias_videoversion', 'status')


        # User chose to not deal with backwards NULL issues for 'VideoVersion.type'
        raise RuntimeError("Cannot reverse this migration. 'VideoVersion.type' and its values cannot be restored.")
