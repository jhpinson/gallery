...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DropBox.delta'
        db.alter_column('medias_dropbox', 'delta', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

    def backwards(self, orm):

        # Changing field 'DropBox.delta'
        db.alter_column('medias_dropbox', 'delta', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))
