...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('medias_media', (
            ...
            ('status', self.gf('django.db.models.fields.CharField')(default='published', max_length=20)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('description', self.gf('django.db.models.fields.TextField')(max_length=2048, null=True, blank=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('file_creation_date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('meta_date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('original_file', self.gf('filehashfield.fields.FileHashField')(max_length=1024, null=True)),
            ('custom_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True)),
            ...
            ('parent_album', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='medias', null=True, to=orm['medias.Album'])),
            ('is_an_album', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ))
        db.send_create_signal('medias', ['Media'])

        # Adding unique constraint on 'Media', fields ['hash', 'parent_album']
        db.create_unique('medias_media', ['hash', 'parent_album_id'])
        ...
        db.create_table('medias_videoversion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('video', self.gf('django.db.models.fields.related.ForeignKey')(related_name='video_versions', to=orm['medias.Video'])),
        ...
        db.send_create_signal('medias', ['VideoVersion'])

        # Adding model 'Album'
        db.create_table('medias_album', (
            ('media_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['medias.Media'], unique=True, primary_key=True)),
            ('end_date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('image_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'Media', fields ['hash', 'parent_album']
        db.delete_unique('medias_media', ['hash', 'parent_album_id'])
        ...
        db.delete_table('medias_videoversion')
