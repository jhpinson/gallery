...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('medias_media', 'description', self.gf('django.db.models.fields.TextField')(max_length=2048, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Media.description'
        raise RuntimeError("Cannot reverse this migration. 'Media.description' and its values cannot be restored.")
