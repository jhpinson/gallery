...
class ImageHashFileDescriptor(ImageFileDescriptor):
    """
    ...
    def __set__(self, instance, value):
        ...
        super(ImageHashFileDescriptor, self).__set__(instance, value)
...
class ImageHashField(ImageField):
    attr_class = ImageFieldFile
    descriptor_class = ImageHashFileDescriptor
    description = _("Image")
    
    def __init__(self, verbose_name=None, name=None, width_field=None,
            height_field=None, hash_field='hash', **kwargs):
        self.hash_field = hash_field
        super(ImageHashField, self).__init__(verbose_name, name, width_field, height_field, **kwargs)
...
if 'south' in settings.INSTALLED_APPS:
    ...
    add_introspection_rules([], ["^imagehashfield\.fields\.ImageHashField"])
